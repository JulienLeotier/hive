...
//
// Auth: none. Hive is a local single-user BMAD tool — there's no login,
// no API keys, no RBAC. The Go server injects an admin context on every
// request (see api.localAdminContext).
